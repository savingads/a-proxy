...
# from routes.persona import persona_bp  # Original implementation with direct DB access
from routes.persona_api import persona_bp  # New implementation using API
