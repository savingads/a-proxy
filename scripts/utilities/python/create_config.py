#!/usr/bin/env python3
"""
Script to create the persona field configuration

This script creates the persona_field_config.py file with the default field configuration
"""
import os
import sys
import logging
...
def get_config_content():
    """Return the content for the config file"""
    return '''"""
...
def create_config_file():
    """Create the persona_field_config.py file in the current directory"""
    if os.path.exists('persona_field_config.py'):
        logger.info("persona_field_config.py already exists")
        return
        
    logger.info("Creating persona_field_config.py")
    
    with open('persona_field_config.py', 'w') as f:
        f.write(get_config_content())
        
    logger.info("Created persona_field_config.py successfully")
