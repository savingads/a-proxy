...
# Script to start both the Persona API service and A-Proxy together
...
echo -e "${YELLOW}Starting A-Proxy with Persona API Service${NC}"
echo "=================================================="
...
mkdir -p data persona-service/data nordvpn/ovpn_udp nordvpn/ovpn_tcp
